...
5. Target Filament 5 on Laravel 11, 12 and 13, building on `bbs-lab/laravel-okta`.
6. Add tests and update the [CHANGELOG](CHANGELOG.md). Browser (`composer test:browser`) and live Playwright (`npm run e2e`) suites need a browser installed.
